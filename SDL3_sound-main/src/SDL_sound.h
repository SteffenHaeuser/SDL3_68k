...
#if defined(SDL_SOUND_DLL_EXPORTS) && (defined(_WIN32) || defined(SDL_PLATFORM_OS2))
#  define SNDDECLSPEC __declspec(dllexport)
#elif ((defined(__GNUC__) && (__GNUC__ >= 4)) || defined(__clang__)) && !(defined(_WIN32) || defined(SDL_PLATFORM_OS2))
