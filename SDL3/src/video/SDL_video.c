...
#ifdef __AMIGAOS3__
/* MiniGL uses the native m68k C calling convention. */
#ifndef APIENTRY
#define APIENTRY
#endif
#endif
...
#if !defined(SDL_VIDEO_OPENGL) || defined(__AMIGAOS3__)
...
#define GL_NUM_EXTENSIONS 0x821D
    ...
    // MiniGL/OpenGL 1.x and pre-GL3 use glGetString(GL_EXTENSIONS).
...
bool SDL_GL_GetAttribute(SDL_GLAttr attr, int *value)
{
    ...
    /* MiniGL is an OpenGL 1.x backend.  Do not run SDL3's GL3/FBO
       introspection here; report the context values requested/configured
       through SDL instead. */
    switch (attr) {
    case SDL_GL_RED_SIZE:                   *value = _this->gl_config.red_size; return true;
    case SDL_GL_GREEN_SIZE:                 *value = _this->gl_config.green_size; return true;
    case SDL_GL_BLUE_SIZE:                  *value = _this->gl_config.blue_size; return true;
    case SDL_GL_ALPHA_SIZE:                 *value = _this->gl_config.alpha_size; return true;
    case SDL_GL_BUFFER_SIZE:
        *value = _this->gl_config.buffer_size;
        if (*value == 0) {
            *value = _this->gl_config.red_size + _this->gl_config.green_size +
                     _this->gl_config.blue_size + _this->gl_config.alpha_size;
        }
        return true;
    case SDL_GL_DOUBLEBUFFER:               *value = _this->gl_config.double_buffer; return true;
    case SDL_GL_DEPTH_SIZE:                 *value = _this->gl_config.depth_size; return true;
    case SDL_GL_STENCIL_SIZE:               *value = _this->gl_config.stencil_size; return true;
    case SDL_GL_ACCUM_RED_SIZE:             *value = _this->gl_config.accum_red_size; return true;
    case SDL_GL_ACCUM_GREEN_SIZE:           *value = _this->gl_config.accum_green_size; return true;
    case SDL_GL_ACCUM_BLUE_SIZE:            *value = _this->gl_config.accum_blue_size; return true;
    case SDL_GL_ACCUM_ALPHA_SIZE:           *value = _this->gl_config.accum_alpha_size; return true;
    case SDL_GL_STEREO:                     *value = _this->gl_config.stereo; return true;
    case SDL_GL_MULTISAMPLEBUFFERS:         *value = _this->gl_config.multisamplebuffers; return true;
    case SDL_GL_MULTISAMPLESAMPLES:         *value = _this->gl_config.multisamplesamples; return true;
    case SDL_GL_ACCELERATED_VISUAL:         *value = _this->gl_config.accelerated; return true;
    case SDL_GL_RETAINED_BACKING:           *value = _this->gl_config.retained_backing; return true;
    case SDL_GL_CONTEXT_MAJOR_VERSION:      *value = _this->gl_config.major_version; return true;
    case SDL_GL_CONTEXT_MINOR_VERSION:      *value = _this->gl_config.minor_version; return true;
    case SDL_GL_CONTEXT_FLAGS:              *value = _this->gl_config.flags; return true;
    case SDL_GL_CONTEXT_PROFILE_MASK:       *value = _this->gl_config.profile_mask; return true;
    case SDL_GL_SHARE_WITH_CURRENT_CONTEXT: *value = _this->gl_config.share_with_current_context; return true;
    case SDL_GL_FRAMEBUFFER_SRGB_CAPABLE:   *value = 0; return true;
    case SDL_GL_CONTEXT_RELEASE_BEHAVIOR:   *value = _this->gl_config.release_behavior; return true;
    case SDL_GL_CONTEXT_RESET_NOTIFICATION: *value = _this->gl_config.reset_notification; return true;
    case SDL_GL_CONTEXT_NO_ERROR:           *value = _this->gl_config.no_error; return true;
    case SDL_GL_FLOATBUFFERS:               *value = 0; return true;
    case SDL_GL_EGL_PLATFORM:               *value = 0; return true;
    default:
        *value = 0;
...
#if (defined(SDL_VIDEO_OPENGL) || defined(SDL_VIDEO_OPENGL_ES) || defined(SDL_VIDEO_OPENGL_ES2)) && !defined(__AMIGAOS3__)
